...
public class GuiItemReplacementPicker extends GuiBase {
    ...
    protected void drawContents(DrawContext drawContext, int mouseX, int mouseY, float partialTicks) {
        ...
        RenderUtils.drawRect(this.gridX - 2, this.gridY - 2, this.gridColumns * CELL_SIZE + 4, this.gridRows * CELL_SIZE + 4, 0x6630353D);
        ...
        if (this.ignoreButton != null && this.ignoreButton.isMouseOver(mouseX, mouseY)) {
            RenderUtils.drawHoverText(mouseX, mouseY,
                    List.of(StringUtils.translate("litematica_container_filler.gui.tooltip.material_replace_ignore")), drawContext);
        }
    }
