        ...
        for (Replacement rep : REPLACEMENTS) {
            if (rep.source.matches(original)) {
                ...
                if (original.contains(DataComponentTypes.CUSTOM_NAME)) {
                    newStack.set(DataComponentTypes.CUSTOM_NAME, original.get(DataComponentTypes.CUSTOM_NAME));
                }
                if (original.contains(DataComponentTypes.ENCHANTMENTS)) {
                    newStack.set(DataComponentTypes.ENCHANTMENTS, original.get(DataComponentTypes.ENCHANTMENTS));
                }
                if (original.contains(DataComponentTypes.CUSTOM_DATA)) {
                    newStack.set(DataComponentTypes.CUSTOM_DATA, original.get(DataComponentTypes.CUSTOM_DATA));
                }
